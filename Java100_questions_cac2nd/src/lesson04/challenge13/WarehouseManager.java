...
public class WarehouseManager {
	...
	public static void main(String[] args) throws IOException {
		...
		//配列の宣言および初期化処理を記述する
		//【思考メモ】挨拶パターンを配列に入れるためString型配列で初期化
		//★挨拶は英語で「greeting」		
		...
		//【思考メモ】挨拶配列を作成したためfor文で繰り返し取り出し出力する
		...
		//入力処理および入力値の代入処理
		//【思考メモ】readLineメソッドで①どの挨拶パターンを変更するか選んで入力。②挨拶パターンを入力し、配列変更
		System.out.print("どのパターンを変更しますか＞");
		String choiseNumStr = br.readLine();
		int choiseNum = Integer.parseInt(choiseNumStr) - 1;

		System.out.print("あいさつを吹き込んでください＞");
		String greeting = br.readLine();

		greetingArray[choiseNum] = greeting;
